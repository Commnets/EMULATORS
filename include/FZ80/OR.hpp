...
namespace FZ80
{
	...
	inline bool OR_General::executeWith (const MCHEmul::UByte& v)
	{
		...
		st.setBitStatus (CZ80::_BIT3FLAG, rst.bit (3)); // a copy of the status of the bit 3... but undocumented!
		st.setBitStatus (CZ80::_HALFCARRYFLAG, false);
		st.setBitStatus (CZ80::_BIT5FLAG, rst.bit (5)); // a copy of the status of the bit 5... but undocumented!
