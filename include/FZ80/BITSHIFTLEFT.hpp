...
namespace FZ80
{
	...
	// ---
	inline bool BITSHIFTLeft_General::executeRotateWith (MCHEmul::Register& r, bool crr)
	{
	...
	// ---
	inline bool BITSHIFTLeft_General::executeRotateWith (const MCHEmul::Address& a, bool crr)
	{
		MCHEmul::StatusRegister& st = cpu () -> statusRegister ();
	...
	// ---
	inline bool BITSHIFTLeft_General::executeRotateWith (const MCHEmul::Address& a, MCHEmul::Register& r, bool crr)
	{
		MCHEmul::StatusRegister& st = cpu () -> statusRegister ();
	...
	// ---
	inline bool BITSHIFTLeft_General::executeShiftWith (MCHEmul::Register& r, bool crr)
	{
		MCHEmul::UByte v = r.values ()[0];
	...
	// ---
	inline bool BITSHIFTLeft_General::executeShiftWith (const MCHEmul::Address& a, bool crr)
	{
		MCHEmul::UByte v = memory () -> value (a);
		bool c = v.shiftLeftC (crr);
		memory () -> set (a, v); // Set back the value...
	...
	// ---
	inline bool BITSHIFTLeft_General::executeShiftWith (const MCHEmul::Address& a, MCHEmul::Register& r, bool crr)
	{
		MCHEmul::UByte v = memory () -> value (a);
		bool c = v.shiftLeftC (crr);
		memory () -> set (a, v); // Set back the value...
