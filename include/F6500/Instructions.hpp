...
namespace F6500
{
	...
	_INST_FROM (0x6D, 3, 4, "ADC$[1][2]",	ADC_Absolute, ADC_General);
	...
	_INST_FROM (0x7D, 3, 4, "ADC$[1][2],X",	ADC_AbsoluteX, ADC_General);
	_INST_FROM (0x79, 3, 4, "ADC$[1][2],Y",	ADC_AbsoluteY, ADC_General);
	...
	_INST_FROM (0x2D, 3, 4, "AND$[1][2]",	AND_Absolute, AND_General);
	...
	_INST_FROM (0x3D, 3, 4, "AND$[1][2],X",	AND_AbsoluteX, AND_General);
	_INST_FROM (0x39, 3, 4, "AND$[1][2],Y",	AND_AbsoluteY, AND_General);
	...
	_INST_FROM (0x0E, 3, 6, "ASL$[1][2]",	ASL_Absolute, ASL_General);
	...
	_INST_FROM (0x1E, 3, 7, "ASL$[1][2],X",	ASL_AbsoluteX, ASL_General);
	...
	// BIT
	_INST_FROM (0x2C, 3, 4, "BIT$[1][2]",	BIT_Absolute, Instruction);
	...
	_INST_FROM (0xCD, 3, 4, "CMP$[1][2]",	CMP_Absolute, CMP_General);
	...
	_INST_FROM (0xDD, 3, 4, "CMP$[1][2],X",	CMP_AbsoluteX, CMP_General);
	_INST_FROM (0xD9, 3, 4, "CMP$[1][2],Y",	CMP_AbsoluteY, CMP_General);
	...
	_INST_FROM (0xEC, 3, 4, "CPX$[1][2]",	CPX_Absolute, CPX_General);
	...
	_INST_FROM (0xCC, 3, 4, "CPY$[1][2]",	CPY_Absolute, CPY_General);
	...
	_INST_FROM (0xCE, 3, 6, "DEC$[1][2]",	DEC_Absolute, DEC_General);
	_INST_FROM (0xC6, 2, 5, "DEC$[1]",		DEC_ZeroPage, DEC_General);
	_INST_FROM (0xD6, 2, 6, "DEC$[1],X",	DEC_ZeroPageX, DEC_General);
	_INST_FROM (0xDE, 3, 7, "DEC$[1][2],X",	DEC_AbsoluteX, DEC_General);
	...
	_INST_FROM (0x4D, 3, 4, "EOR$[1][2]",	EOR_Absolute, EOR_General);
	...
	_INST_FROM (0x5D, 3, 4, "EOR$[1][2],X",	EOR_AbsoluteX, EOR_General);
	_INST_FROM (0x59, 3, 4, "EOR$[1][2],Y",	EOR_AbsoluteY, EOR_General);
	...
	_INST_FROM (0xEE, 3, 6, "INC$[1][2]",	INC_Absolute, INC_General);
	_INST_FROM (0xE6, 2, 5, "INC$[1]",		INC_ZeroPage, INC_General);
	_INST_FROM (0xF6, 2, 6, "INC$[1],X",	INC_ZeroPageX, INC_General);
	_INST_FROM (0xFE, 3, 7, "INC$[1][2],X",	INC_AbsoluteX, INC_General);
	...
	// JMP
	_INST_FROM (0x4C, 3, 3, "JMP$[1][2]",	JMP_Absolute, Instruction);
	_INST_FROM (0x6C, 3, 5, "JMP($[1][2])",	JMP_Indirect, Instruction);

	// JSR
	_INST_FROM (0x20, 3, 6, "JSR$[1][2]",	JSR_Absolute, Instruction);
	...
	_INST_FROM (0xAD, 3, 4, "LDA$[1][2]",	LDA_Absolute, LDA_General);
	...
	_INST_FROM (0xBD, 3, 4, "LDA$[1][2],X",	LDA_AbsoluteX, LDA_General);
	_INST_FROM (0xB9, 3, 4, "LDA$[1][2],Y",	LDA_AbsoluteY, LDA_General);
	...
	_INST_FROM (0xAE, 3, 4, "LDX$[1][2]",	LDX_Absolute, LDX_General);
	_INST_FROM (0xA6, 2, 3, "LDX$[1]",		LDX_ZeroPage, LDX_General);
	_INST_FROM (0xBE, 3, 4, "LDX$[1][2],Y",	LDX_AbsoluteY, LDX_General);
	...
	_INST_FROM (0xAC, 3, 4, "LDY$[1][2]",	LDY_Absolute, LDY_General);
	_INST_FROM (0xA4, 2, 3, "LDY$[1]",		LDY_ZeroPage, LDY_General);
	_INST_FROM (0xB4, 2, 4, "LDY$[1],X",	LDY_ZeroPageX, LDY_General);
	_INST_FROM (0xBC, 3, 4, "LDY$[1][2],X",	LDY_AbsoluteX, LDY_General);
	...
	_INST_FROM (0x4E, 3, 6, "LSR$[1][2]",	LSR_Absolute, LSR_General);
	...
	_INST_FROM (0x5E, 3, 7, "LSR$[1][2],X",	LSR_AbsoluteX, LSR_General);
	...
	_INST_FROM (0x0D, 3, 4, "ORA$[1][2]",	ORA_Absolute, ORA_General);
	...
	_INST_FROM (0x1D, 3, 4, "ORA$[1][2],X",	ORA_AbsoluteX, ORA_General);
	_INST_FROM (0x19, 3, 4, "ORA$[1][2],Y",	ORA_AbsoluteY, ORA_General);
	...
	_INST_FROM (0x2E, 3, 6, "ROL$[1][2]",	ROL_Absolute, ROL_General);
	...
	_INST_FROM (0x3E, 3, 7, "ROL$[1][2],X",	ROL_AbsoluteX, ROL_General);
	...
	_INST_FROM (0x6E, 3, 6, "ROR$[1][2]",	ROR_Absolute, ROR_General);
	...
	_INST_FROM (0x7E, 3, 7, "ROR$[1][2],X",	ROR_AbsoluteX, ROR_General);
	...
	_INST_FROM (0xED, 3, 4, "SBC$[1][2]",	SBC_Absolute, SBC_General);
	...
	_INST_FROM (0xFD, 3, 4, "SBC$[1][2],X",	SBC_AbsoluteX, SBC_General);
	_INST_FROM (0xF9, 3, 4, "SBC$[1][2],Y",	SBC_AbsoluteY, SBC_General);
	...
	_INST_FROM (0x8D, 3, 4, "STA$[1][2]",	STA_Absolute, STA_General);
	...
	_INST_FROM (0x9D, 3, 5, "STA$[1][2],X",	STA_AbsoluteX, STA_General);
	_INST_FROM (0x99, 3, 5, "STA$[1][2],Y",	STA_AbsoluteY, STA_General);
	...
	_INST_FROM (0x8E, 3, 4, "STX$[1][2]",	STX_Absolute, STX_General);
	...
	_INST_FROM (0x8C, 3, 4, "STY$[1][2]",	STY_Absolute, STY_General);
