 ...
 *	Description: To emulate the behaviour of a cartridge in the VIC20 computer
 *	Versions: 1.0 Initial
 */

#ifndef __VIC20_CARTRIDGE__
#define __VIC20_CARTRIDGE__
...
namespace VIC20
{
	...
	class Cartridge final : public COMMODORE::ExpansionPeripheral
	{
		...
		void dumpDataInto (VIC20::Memory* m, MCHEmul::MemoryView* mV);
