...
namespace MSX
{
	...
	{
		public:
		static const int _RAMB216KSLOT0SUBSLOT0_SUBSET = 1102;		// Slot 0, Subslot 0, Bank 2-3. 32K RAM configuration...
	...
	class CanonV20 final : public MSX1Model
	{
		...
		static const int _RAMB016KSLOT3SUBSLOT0_SUBSET	= 1400;	// Slot 3, Subslot 0, Bank 0. 16K RAM...
		static const int _RAMB116KSLOT3SUBSLOT0_SUBSET	= 1401;	// Slot 3, Subslot 0, Bank 1. 16K RAM...
		static const int _RAMB216KSLOT3SUBSLOT0_SUBSET	= 1402;	// Slot 3, Subslot 0, Bank 2. 16K RAM...
		static const int _RAMB316KSLOT3SUBSLOT0_SUBSET	= 1403;	// Slot 3, Subslot 0, Bank 3. 16K RAM...
		static const int _RAMBASESLOT3SUBSLOT0_SUBSET	= 1400;	// Slot 3, Subslot 0, Bank 3. 16K RAM...
