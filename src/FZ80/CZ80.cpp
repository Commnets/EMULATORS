...
MCHEmul::Instructions FZ80::CZ80::createInstructions ()
{
	...
	// RES
	result [0xCB87]				= new FZ80::RES_0WithA;
	result [0xCB80]				= new FZ80::RES_0WithB;
	result [0xCB81]				= new FZ80::RES_0WithC;
	result [0xCB82]				= new FZ80::RES_0WithD;
	result [0xCB83]				= new FZ80::RES_0WithE;
	result [0xCB84]				= new FZ80::RES_0WithH;
	result [0xCB85]				= new FZ80::RES_0WithL;
	result [0xCB86]				= new FZ80::RES_0WithIndirectHL;
	...
	DDCBInstructions [0xDDCB86] = new FZ80::RES_0WithIndirectIndexIY; 
	DDCBInstructions [0xDDCB87] = new FZ80::RES_0WithIndirectIndexIYCopyA;	// Undocumented
	DDCBInstructions [0xDDCB80] = new FZ80::RES_0WithIndirectIndexIYCopyB;	// Undocumented
	DDCBInstructions [0xDDCB81] = new FZ80::RES_0WithIndirectIndexIYCopyC;	// Undocumented
	DDCBInstructions [0xDDCB82] = new FZ80::RES_0WithIndirectIndexIYCopyD;	// Undocumented
	DDCBInstructions [0xDDCB83] = new FZ80::RES_0WithIndirectIndexIYCopyE;	// Undocumented
	DDCBInstructions [0xDDCB84] = new FZ80::RES_0WithIndirectIndexIYCopyH;	// Undocumented
	DDCBInstructions [0xDDCB85] = new FZ80::RES_0WithIndirectIndexIYCopyL;	// Undocumented
	result [0xCB8F]				= new FZ80::RES_1WithA;
	result [0xCB88]				= new FZ80::RES_1WithB;
	result [0xCB89]				= new FZ80::RES_1WithC;
	result [0xCB8A]				= new FZ80::RES_1WithD;
	result [0xCB8B]				= new FZ80::RES_1WithE;
	result [0xCB8C]				= new FZ80::RES_1WithH;
	result [0xCB8D]				= new FZ80::RES_1WithL;
	result [0xCB8E]				= new FZ80::RES_1WithIndirectHL;
	...
	result [0xCB97]				= new FZ80::RES_2WithA;
	result [0xCB90]				= new FZ80::RES_2WithB;
	result [0xCB91]				= new FZ80::RES_2WithC;
	result [0xCB92]				= new FZ80::RES_2WithD;
	result [0xCB93]				= new FZ80::RES_2WithE;
	result [0xCB94]				= new FZ80::RES_2WithH;
	result [0xCB95]				= new FZ80::RES_2WithL;
	result [0xCB96]				= new FZ80::RES_2WithIndirectHL;
	...
	result [0xCB9F]				= new FZ80::RES_3WithA;
	result [0xCB98]				= new FZ80::RES_3WithB;
	result [0xCB99]				= new FZ80::RES_3WithC;
	result [0xCB9A]				= new FZ80::RES_3WithD;
	result [0xCB9B]				= new FZ80::RES_3WithE;
	result [0xCB9C]				= new FZ80::RES_3WithH;
	result [0xCB9D]				= new FZ80::RES_3WithL;
	result [0xCB9E]				= new FZ80::RES_3WithIndirectHL;
	...
	result [0xCBA7]				= new FZ80::RES_4WithA;
	result [0xCBA0]				= new FZ80::RES_4WithB;
	result [0xCBA1]				= new FZ80::RES_4WithC;
	result [0xCBA2]				= new FZ80::RES_4WithD;
	result [0xCBA3]				= new FZ80::RES_4WithE;
	result [0xCBA4]				= new FZ80::RES_4WithH;
	result [0xCBA5]				= new FZ80::RES_4WithL;
	result [0xCBA6]				= new FZ80::RES_4WithIndirectHL;
	...
	result [0xCBAF]				= new FZ80::RES_5WithA;
	result [0xCBA8]				= new FZ80::RES_5WithB;
	result [0xCBA9]				= new FZ80::RES_5WithC;
	result [0xCBAA]				= new FZ80::RES_5WithD;
	result [0xCBAB]				= new FZ80::RES_5WithE;
	result [0xCBAC]				= new FZ80::RES_5WithH;
	result [0xCBAD]				= new FZ80::RES_5WithL;
	result [0xCBAE]				= new FZ80::RES_5WithIndirectHL;
	...
	result [0xCBB7]				= new FZ80::RES_6WithA;
	result [0xCBB0]				= new FZ80::RES_6WithB;
	result [0xCBB1]				= new FZ80::RES_6WithC;
	result [0xCBB2]				= new FZ80::RES_6WithD;
	result [0xCBB3]				= new FZ80::RES_6WithE;
	result [0xCBB4]				= new FZ80::RES_6WithH;
	result [0xCBB5]				= new FZ80::RES_6WithL;
	result [0xCBB6]				= new FZ80::RES_6WithIndirectHL;
	...
	result [0xCBBF]				= new FZ80::RES_7WithA;
	result [0xCBB8]				= new FZ80::RES_7WithB;
	result [0xCBB9]				= new FZ80::RES_7WithC;
	result [0xCBBA]				= new FZ80::RES_7WithD;
	result [0xCBBB]				= new FZ80::RES_7WithE;
	result [0xCBBC]				= new FZ80::RES_7WithH;
	result [0xCBBD]				= new FZ80::RES_7WithL;
	result [0xCBBE]				= new FZ80::RES_7WithIndirectHL;
	...
	// JP
	result [0xC3]				= new JP;
	result [0xC2]				= new JP_NZ;
	result [0xCA]				= new JP_Z;
	result [0xD2]				= new JP_NC;
	result [0xDA]				= new JP_C;
	result [0xE2]				= new JP_PO;
	result [0xEA]				= new JP_PE;
	result [0xF2]				= new JP_P;
	result [0xFA]				= new JP_M;
	result [0xE9]				= new JP_IndirectHL;
	DDInstructions [0xDDE9]		= new JP_IndirectIX;
	DDInstructions [0xFDE9]		= new JP_IndirectIY;

	// JR
	result [0x18]				= new JR;
	result [0x20]				= new JR_NZ;
	result [0x28]				= new JR_Z;
	result [0x30]				= new JR_NC;
	result [0x38]				= new JR_C;

	// DJNZ
	result [0x10]				= new DJNZ;

	// CALL
	result [0xCD]				= new CALL;
	result [0xC4]				= new CALL_NZ;
	result [0xCC]				= new CALL_Z;
	result [0xD4]				= new CALL_NC;
	result [0xDC]				= new CALL_C;
	result [0xE4]				= new CALL_PO;
	result [0xEC]				= new CALL_PE;
	result [0xF4]				= new CALL_P;
	result [0xFC]				= new CALL_M;

	// RET
	result [0xC9]				= new RET;
	result [0xC0]				= new RET_NZ;
	result [0xC8]				= new RET_Z;
	result [0xD0]				= new RET_NC;
	result [0xD8]				= new RET_C;
	result [0xE0]				= new RET_PO;
	result [0xE8]				= new RET_PE;
	result [0xF0]				= new RET_P;
	result [0xF8]				= new RET_M;
