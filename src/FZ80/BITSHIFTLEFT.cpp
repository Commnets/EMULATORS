...
// ---
bool FZ80::BITSHIFTLeft_General::executeRotateWith (MCHEmul::Register& r, bool crr)
{
...
// ---
bool FZ80::BITSHIFTLeft_General::executeRotateWith (const MCHEmul::Address& a, bool crr)
{
	MCHEmul::StatusRegister& st = cpu () -> statusRegister ();
...
// ---
bool FZ80::BITSHIFTLeft_General::executeRotateWith (const MCHEmul::Address& a, MCHEmul::Register& r, bool crr)
{
	MCHEmul::StatusRegister& st = cpu () -> statusRegister ();
...
// ---
bool FZ80::BITSHIFTLeft_General::executeShiftWith (MCHEmul::Register& r, bool crr)
{
	MCHEmul::UByte v = r.values ()[0];
	bool c = v.bit (7);
	v.shiftLeftC (crr);
...
// ---
bool FZ80::BITSHIFTLeft_General::executeShiftWith (const MCHEmul::Address& a, bool crr)
{
	MCHEmul::UByte v = memory () -> value (a);
	bool c = v.bit (7);
	v.shiftLeftC (crr);
...
// ---
bool FZ80::BITSHIFTLeft_General::executeShiftWith (const MCHEmul::Address& a, MCHEmul::Register& r, bool crr)
{
	MCHEmul::UByte v = memory () -> value (a);
	bool c = v.bit (7);
	v.shiftLeftC (crr);
