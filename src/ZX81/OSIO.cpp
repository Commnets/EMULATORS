...
// ---
const ZX81::InputOSSystem::KeystrockesMap ZX81::InputOSSystem::_ZX81KEYS
	(
		{
			// Row 0
			...
			{ SDL_SCANCODE_PERIOD,			{ std::make_pair (7, 1) } },
...
const ZX81::InputOSSystem::Keystrokes ZX81::InputOSSystem::_NOKEYSTROKES = { };

// ---
ZX81::InputOSSystem::InputOSSystem ()
...
// ---
void ZX81::InputOSSystem::linkToChips (const MCHEmul::Chips& c)
{
	for (MCHEmul::Chips::const_iterator i = c.begin (); i != c.end (); i++)
		if (dynamic_cast <ZX81::ULA*> ((*i).second) != nullptr)
