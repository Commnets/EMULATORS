...
const MCHEmul::Attributes C64::StandardSerialPrinterSimulation::_ATTRIBUTES =
		...
		{
			{
				...
				"Serial Listen", // When the attention ofthe device is requested...
			...
			{ 
				...
				"Serial SA Listen", // When the secondary address is requested....
			...
			{ 
				...
				"Serial Send Byte", // When a byte is set to the device...
			...
			{ 
				...
				"Serial Receive Byte", // When a byte is received from the device...
