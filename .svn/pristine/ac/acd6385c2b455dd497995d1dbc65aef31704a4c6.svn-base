...
namespace C64
{
	...
	class VICMemory final : public MCHEmul::Memory
	{
		public:
		VICMemory ();
		...
		bool graphicsBitModeActive () const
							{ return (_graphicsBitModeActive); }
		bool graphicsExtendedColorTextModeActive () const
							{ return (_graphicsExtendedColorTextModeActive); }
		bool graphicsMulticolorTextModeActive () const
							{ return (_graphicsMulticolorTextModeActive); }
		...
		unsigned char currentLightPenHorizontalPosition () const
							{ return (_currentLightPenHorizontalPosition); }
		unsigned char currentLightPenVerticalPosition () const
		...
		// Graphical modes
		bool _graphicsBitModeActive;
		bool _graphicsExtendedColorTextModeActive;
		bool _graphicsMulticolorTextModeActive;
		// IRQ Control
		...
		unsigned char _currentLightPenHorizontalPosition, _currentLightPenVerticalPosition;
