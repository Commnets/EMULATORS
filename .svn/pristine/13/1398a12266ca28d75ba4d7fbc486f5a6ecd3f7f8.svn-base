...
namespace MCHEmul
{
	...
	class CommunicationMessage
	{
		...
		/** The very important method. \n
			...
			The method returns a number than can be additional info for the invoker.
			NOTE that Default result should be 0 meaning "No additional info for invoker". */
		virtual unsigned int executeOn (Computer*, CommunicationMessage*&) = 0;
