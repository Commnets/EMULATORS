...
F6500::C6510::C6510 ()
	: MCHEmul::CPU (
		F6500::C6510::createArchitecture (), 
		F6500::C6510::createInternalRegisters (), 
...
// ---
MCHEmul::Registers F6500::C6510::createInternalRegisters ()
{
	MCHEmul::Registers result;

	result.push_back (MCHEmul::Register ((int) _ACCUMULATOR,	{ MCHEmul::UByte::_0 } /** 1 byte long */)); // Accumulator
	result.push_back (MCHEmul::Register ((int) _XREGISTER,		{ MCHEmul::UByte::_0 } /** 1 byte long */)); // X Register
	result.push_back (MCHEmul::Register ((int) _YREGISTER,		{ MCHEmul::UByte::_0 } /** 1 byte long */)); // Y Register

	return (result);
}

// ---
MCHEmul::StatusRegister F6500::C6510::createStatusRegister ()
{
...
// ---
MCHEmul::Instructions F6500::C6510::createInstructions ()
{
	...
	// AND
	result [0x29] = new ADC_Inmediate;
	result [0x2D] = new ADC_Absolute;
	result [0x25] = new ADC_ZeroPage;
	result [0x21] = new ADC_ZeroPageIndirectX;
	result [0x31] = new ADC_ZeroPageIndirectY;
	result [0x35] = new ADC_ZeroPageX;
	result [0x3D] = new ADC_AbsoluteX;
	result [0x39] = new ADC_AbsoluteY;
