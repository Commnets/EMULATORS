...
bool C64::Commodore64::initialize ()
{
	...
	// Both chips are link somehow...
	// When the register 0 of the CIA2 (0xdd00)
	dynamic_cast <C64::CIA2*> (chip (C64::CIA2::_ID)) -> setVICIIRef (dynamic_cast <C64::VICII*> (chip (C64::VICII::_ID)));
