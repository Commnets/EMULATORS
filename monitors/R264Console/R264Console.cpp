...
int _tmain (int argc, _TCHAR *argv [])
{
	...
	std::cout << "It can send instructions to a C264 emulator and receive the answers from it" << std::endl;
	std::cout << "/h\t\tJust for help" << std::endl; 
	std::cout << "/i[IPADDRESS]\tAddress of the C264 emulator to monitor (xxx (1 to 255).xxx.xxx.xxx:xxxxx (0 - 65535)" << std::endl;
